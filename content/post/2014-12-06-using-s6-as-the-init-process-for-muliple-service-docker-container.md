...
## 寫在後面
  ...
  - 如果只是要處理 signal forward 讓服務可以 graceful shutdown，則完全沒有必要引入 init process，透過一隻 Bash wrapper 加幾行 trap/wait 就可以辦到，強者我同事 [Bash 狂人](https://github.com/tsaikd) 就是這樣搞的。
